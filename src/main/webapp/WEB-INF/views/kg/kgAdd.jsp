...
<article class="page-container">
	...
	<form action="/doKgAdd" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>知识元课程：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" disabled="disabled" class="input-text" value="${param.courseName}" placeholder="" id="kgName" name="courseName">
			</div>
		</div>
		<div class="row cl">
