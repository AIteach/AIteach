...
<article class="page-container">
	<span style="text-align:center;color:blue"><h1>添加知识元</h1></span>
	</br></br></br></br>
	<form action="/doKgAddKg" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" disabled="disabled" class="input-text" value="${courseNode.courseName}" placeholder="" id="kgName" name="courseName">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">知识元描述</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<input type="hidden" value="${param.kgId}" name="kgParid">
