        ...
        <div id="leftli">
            <ul class="firstul">
                ...
                <div class="secmenu" id="sch-secmenu">
                     <ul>
                          <li><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp<span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>&nbsp&nbsp佛山科学技术学院</li>
                     </ul> 
                </div>
                ...
                <li class="firstli" id="kg" value="记得去后面设置点击张开"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp<span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>&nbsp&nbsp知识点                 
                </li>
                <div class="secmenu" id="tea-secmenu">
                       <ul>
                       		 <c:forEach var="kg" items="${kgNode}">
                            <li><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>&nbsp<span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>&nbsp&nbsp${kg.kgName}</li>
                             </c:forEach>
                        </ul> 
                </div> 
            </ul>
