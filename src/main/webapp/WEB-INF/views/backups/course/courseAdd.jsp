...
<article class="page-container">
	<span style="text-align:center;color:blue"><h1>添加课程</h1></span>
	</br></br></br></br>
	<form action="/courseAdd" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>学校名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" disabled="disabled" class="input-text" value="${param.schoolName}" placeholder="" id="schoolName" name="schoolName">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>课程名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="请输入新的知识点名" id="courseName" name="courseName">
			</div>
		</div>
		<div class="row cl">
		...
		<input type="hidden" value="必修课程" name="value" id="value">
